...
/* package seis-0.1.0.0 */
#ifndef VERSION_seis
#define VERSION_seis "0.1.0.0"
#endif /* VERSION_seis */
#ifndef MIN_VERSION_seis
#define MIN_VERSION_seis(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_seis */
...
#define CURRENT_COMPONENT_ID "seis-0.1.0.0-inplace-seis"
